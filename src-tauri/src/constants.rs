...
pub(crate) const EVENT_SHELL_ACTION: &str = "warble://shell-action";
...
pub(crate) const DEFAULT_PASTE_LAST_SHORTCUT: &str = "F10";
...
pub(crate) const PARAKEET_TDT_AUDIO_LIMIT_MS: u64 = 24 * 60 * 1_000;
pub(crate) const PARAKEET_CTC_AUDIO_LIMIT_MS: u64 = 10 * 60 * 1_000;
...
pub(crate) const TRAY_SETTINGS_ID: &str = "tray-settings";
pub(crate) const TRAY_PASTE_LAST_ID: &str = "tray-paste-last";
pub(crate) const TRAY_RECORD_HOLD_ID: &str = "tray-record-hold";
pub(crate) const TRAY_RECORD_TOGGLE_ID: &str = "tray-record-toggle";
pub(crate) const TRAY_STOP_OR_CANCEL_ID: &str = "tray-stop-or-cancel";
pub(crate) const TRAY_QUIT_ID: &str = "tray-quit";
#[cfg(target_os = "macos")]
pub(crate) const MENU_APP_ABOUT_ID: &str = "menu-app-about";
#[cfg(target_os = "macos")]
pub(crate) const MENU_APP_SETTINGS_ID: &str = "menu-app-settings";
#[cfg(target_os = "macos")]
pub(crate) const MENU_FILE_TRANSCRIBE_ID: &str = "menu-file-transcribe";
#[cfg(target_os = "macos")]
pub(crate) const MENU_FILE_PASTE_LAST_ID: &str = "menu-file-paste-last";
#[cfg(target_os = "macos")]
pub(crate) const MENU_VIEW_CAPTURE_ID: &str = "menu-view-capture";
#[cfg(target_os = "macos")]
pub(crate) const MENU_VIEW_MODELS_ID: &str = "menu-view-models";
#[cfg(target_os = "macos")]
pub(crate) const MENU_VIEW_VOCABULARY_ID: &str = "menu-view-vocabulary";
#[cfg(target_os = "macos")]
pub(crate) const MENU_VIEW_HISTORY_ID: &str = "menu-view-history";
#[cfg(target_os = "macos")]
pub(crate) const MENU_HELP_TROUBLESHOOTING_ID: &str = "menu-help-troubleshooting";
#[cfg(target_os = "macos")]
pub(crate) const MENU_HELP_PROJECT_ID: &str = "menu-help-project";
pub(crate) const SHELL_ACTION_OPEN_SETTINGS: &str = "open-settings";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_OPEN_TROUBLESHOOTING: &str = "open-troubleshooting";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_OPEN_ABOUT: &str = "open-about";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_NAVIGATE_CAPTURE: &str = "navigate-capture";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_NAVIGATE_MODELS: &str = "navigate-models";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_NAVIGATE_VOCABULARY: &str = "navigate-vocabulary";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_NAVIGATE_HISTORY: &str = "navigate-history";
#[cfg(target_os = "macos")]
pub(crate) const SHELL_ACTION_TRANSCRIBE_FILE: &str = "transcribe-file";
#[cfg(target_os = "macos")]
pub(crate) const PROJECT_URL: &str = "https://github.com/ollieatkinson/warble";
